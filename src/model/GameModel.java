...
public class GameModel {
    ...
    private void initMenus() {
        ...
        // Login Menu
        loginButtons.add(
                new MenuButton(185, 407, 122, 41, AssetManager.getInstance().getImage("login_confirm"), "CONFIRM"));
        loginButtons.add(
                new MenuButton(321, 409, 96, 38, AssetManager.getInstance().getImage("login_register"), "GO REGISTER"));
        loginButtons.add(new MenuButton(410, 366, 27, 27, AssetManager.getInstance().getImage("hidePassword"),
                "TOGGLE_PASSWORD"));

        // Register Menu
        registerButtons.add(
                new MenuButton(188, 405, 117, 41, AssetManager.getInstance().getImage("register_confirm"), "CONFIRM"));
        registerButtons
                .add(new MenuButton(320, 407, 96, 38, AssetManager.getInstance().getImage("register_back"), "BACK"));
        registerButtons.add(new MenuButton(407, 364, 27, 27, AssetManager.getInstance().getImage("hidePassword"),
                "TOGGLE_PASSWORD"));
        ...
        // Menu Chính
        mainMenuButtons.add(new MenuButton(68 - 21, 240 - 23, 230, 127,
                AssetManager.getInstance().getImage("Play Button"), "PLAY"));
        mainMenuButtons.add(new MenuButton(354 - 21, 240 - 23, 230, 127,
                AssetManager.getInstance().getImage("Controls Button"), "CONTROLS"));
        mainMenuButtons.add(new MenuButton(68 - 21, 415 - 23, 230, 127,
                AssetManager.getInstance().getImage("Settings Button"), "SETTINGS"));
        mainMenuButtons.add(new MenuButton(354 - 21, 415 - 23, 230, 127,
                AssetManager.getInstance().getImage("Quit Button"), "QUIT"));
    ...
    public List<MenuButton> getMainMenuButtons() {
        return mainMenuButtons;
    }

    public List<MenuButton> getPauseButtons() {
        return pauseButtons;
    }

    public List<MenuButton> getQuitConfirmButtons() {
        return quitConfirmButtons;
    }

    public List<MenuButton> getStartButtons() {
        return startButtons;
    }

    public MenuButton getControlsButtons() {
        return controlsButtons;
    }

    public List<MenuButton> getGamePlayButtons() {
        return gamePlayButtons;
    }

    public List<MenuButton> getGameOverButtons() {
        return gameOverButtons;
    }

    public List<MenuButton> getGameWonButtons() {
        return gameWonButtons;
    }

    public List<MenuButton> getLoginButtons() {
        return loginButtons;
    }

    public List<MenuButton> getRegisterButtons() {
    ...
    public int getSelectedLevelHighScore() {
        return selectedLevelHighScore;
    }

    public void setSelectedLevelHighScore(int selectedLevelHighScore) {
        this.selectedLevelHighScore = selectedLevelHighScore;
    }

    public List<MenuButton> getLevelLockedButtons() {
        return levelLockedButtons;
    }

    public List<MenuButton> getLevelInfoButtons() {
        return levelInfoButtons;
    }
    ...
    public List<MenuButton> getSettingsButtons() {
